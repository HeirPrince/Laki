            ...
            if (auth.getCurrentUser() != null) {
                ...
                online.child(auth.getCurrentUser().getPhoneNumber()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        //true
                        Toast.makeText(AddFriend.this, "connection established", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(AddFriend.this, "connection to db failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
